<x-gymLayout>
    ...
    <form class="row g-3" action="{{route('gimnasta.update', $gimnasta)}}" method="POST">
        ...
        <div class="col-12">
          ...
          <input type="text" class="form-control" name="nombre_g" id="nombre_g" value={{old('nombre_g') ?? $gimnasta->nombre_g}}>
            @error('nombre_g')
                <h5>{{$message}}</h5>
            @enderror
        </div>
        ...
        <div class="col-12">
          ...
          <input type="text" class="form-control" name="apellido_g" id="apellido_g" value={{old('apellido_g') ?? $gimnasta->apellido_g}}>
            @error('apellido_g')
                <h5>{{$message}}</h5>
            @enderror
        </div>
        ...
        <div class="col-12">
          ...
          <input type="date" class="form-control" name="fecha_n_g" id="fecha_n_g" value={{old('fecha_n_g') ?? $gimnasta->fecha_n_g}}>
            @error('fecha_n_g')
                <h5>{{$message}}</h5>
            @enderror
        </div>
