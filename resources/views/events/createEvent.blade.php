<x-gymLayout>
    ...
    <form class="row g-3" action="{{route('event.store')}}" method="POST">
        @csrf
        <div class="col-12">
          <label for="nombre_e" class="form-label">Nombre: </label>
          <input type="text" class="form-control" name="nombre_e" id="nombre_e" value="{{old('nombre_e')}}">
            @error('nombre_e')
                <h5>{{$message}}</h5>
            @enderror
        </div>
        <div class="col-12">
          ...
          <input type="date" class="form-control" name="fecha_i_e" id="fecha_i_e" value="{{old('fecha_i_e')}}">
            @error('fecha_i_e')
                <h5>{{$message}}</h5>
            @enderror
        </div>
        <div class="col-12">
            ...
            <input type="date" class="form-control" name="fecha_f_e" id="fecha_f_e" value="{{old('fecha_f_e')}}">
              @error('fecha_f_e')
                  <h5>{{$message}}</h5>
              @enderror
          </div>
